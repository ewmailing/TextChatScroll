...
{
	[[self pickerCollectionView] setDelegate:the_delegate];
...
//    [self.pickerCollectionView registerClass:[ImageViewCell class] forCellWithReuseIdentifier:@"ImageCell"];
	...
	[self.pickerCollectionView setAllowsSelection:YES];
	[[self pickerCollectionView] setDelegate:_collectionViewDelegate];
